...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2346247322ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=siswa&table=siswa">`siswa`.`siswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=gallery">`managementalumni`.`gallery`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=chat">`managementalumni`.`chat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=akun">`managementalumni`.`akun`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=alumni">`managementalumni`.`alumni`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=komentar">`managementalumni`.`komentar`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=catatanpelamaran">`managementalumni`.`catatanpelamaran`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=feedback_user">`managementalumni`.`feedback_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=tblijazah">`managementalumni`.`tblijazah`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=managementalumni&table=pengajuanloker">`managementalumni`.`pengajuanloker`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7152634d4f436a696a34234c2e7a3973">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="siswa" targettable="siswa">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `siswa`.`siswa` ( `idsiswa` INT(11) NOT NULL AUTO_INCREMENT ,  `namasiswa` VARCHAR(100) NOT NULL ,  `jurusansiswa` VARCHAR(100) NOT NULL ,  `alamat` VARCHAR(100) NOT NULL ,    PRIMARY KEY  (`idsiswa`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="siswa" targettable="siswa">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `siswa` (`idsiswa`, `namasiswa`, `jurusansiswa`, `alamat`) VALUES (NULL, &#039;sawa rajaha&#039;, &#039;IPA&#039;, &#039;JL Persakitan&#039;);</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `siswa`</span>
                        </div>
